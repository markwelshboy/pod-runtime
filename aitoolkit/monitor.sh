...
# Samples
export TELEGRAM_SAMPLES="${TRAIN_STATUS_TELEGRAM_SAMPLES:-1}"
export TELEGRAM_SAMPLES_EVERY="${TRAIN_STATUS_TELEGRAM_SAMPLES_EVERY:-auto}"
export TELEGRAM_SAMPLES_MAX="${TRAIN_STATUS_TELEGRAM_SAMPLES_MAX:-5}"
export TELEGRAM_SAMPLES_STEP="${TRAIN_STATUS_TELEGRAM_SAMPLES_STEP:-latest}"
export TELEGRAM_SAMPLES_ON_STATUS="${TRAIN_STATUS_TELEGRAM_SAMPLES_ON_STATUS:-1}"
export TELEGRAM_SAMPLES_INCLUDE_PROMPTS="${TRAIN_STATUS_TELEGRAM_SAMPLES_INCLUDE_PROMPTS:-10}"
